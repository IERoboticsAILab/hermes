...
- Right glove firmware is currently configured as FSR-only; current FSR pins are GPIO32/GPIO33/GPIO34/GPIO35. These are ADC1 pins, which avoids ESP-NOW/Wi-Fi conflicts on classic ESP32 boards.
